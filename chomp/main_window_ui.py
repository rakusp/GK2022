...
"")
    ...
    def retranslateUi(self, mainMenuWindow):
        ...
        self.comboBox.setItemText(2, _translate("mainMenuWindow", "Min i Max"))
        self.comboBox.setItemText(3, _translate("mainMenuWindow", "Losowe ruchy"))
        ...
        self.comboBox_2.setItemText(1, _translate("mainMenuWindow", "Min i Max"))
